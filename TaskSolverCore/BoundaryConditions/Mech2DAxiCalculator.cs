...
{
    public class Mech2DAxiCalculator : IMechCalculator
    {
        ...
        public Matrix<double> Stiffness_Calc(ElementItem elementItem)
        {
            ...
            var sumStiff = Matrix<double>.Build.Dense(elem.NumberOfPoints * 2, elem.NumberOfPoints * 2);
        ...
        public Vector<double> Force_Calc(ElementItem elementItem, Vector<double> strain)
        {
            ...
            var summForce = Vector<double>.Build.Dense(elem.NumberOfPoints * 2);
        ...
        public float CalcCentralRadius(IElement elem)
        {
            var enCoords = elem.GetVertexes().Select(x => x.Position._x);
            return enCoords.Sum() / elem.NumberOfPoints;
        }
