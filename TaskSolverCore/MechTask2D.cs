...
{
    public class MechTask2D : MechTaskM
    {
        public MechTask2D(int index, string folder,ITaskData taskData, MechanicalParameters parameters) 
...
/// <inheritdoc/>
        ...
        public override Vector<double> GetElasticStrain(int eNumber)
        {
            ...
            return Vector<double>.Build.Dense(new double[] { ex, ey, exy});
        }
